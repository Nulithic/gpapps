...
import { getWalmartOrders } from "@/api/customers/WalmartCA";
...
const WalmartCA = () => {
  ...
  const handleTableOptions = (value: string) => {
    localStorage.setItem("walmartCATableOptions", value);
  ...
  useEffect(() => {
    const prepColumnFilter = () => {
      if (!localStorage.getItem("walmartCAColumnFilters")) {
        localStorage.setItem("walmartCAColumnFilters", JSON.stringify(filterList));
        prepColumnFilter();
      } else {
        let getColumns = JSON.parse(localStorage.getItem("walmartCAColumnFilters")!!);
  ...
  useEffect(() => {
    const prepTableOptions = () => {
      if (!localStorage.getItem("walmartCATableOptions")) {
        localStorage.setItem("walmartCATableOptions", "All Orders");
        prepTableOptions();
      } else {
        let option = localStorage.getItem("walmartCATableOptions")!!;
