...
interface AddLineProps {
  ...
  setAddLineData: Dispatch<SetStateAction<AddLineData>>;
}

const AddLine = ({ addLineData, setAddLineData }: AddLineProps) => {
  const options = [
  ...
  const handleFromLocation = (value: string) => {
    setAddLineData({ ...addLineData, fromLocation: value });
  };
  const handleToLocation = (value: string) => {
    setAddLineData({ ...addLineData, toLocation: value });
  };
  const handleToSKU = (value: string) => {
